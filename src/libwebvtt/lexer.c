...
webvtt_lex_word( webvtt_parser self, webvtt_string *str,
  const webvtt_byte *buffer, webvtt_uint *ppos, webvtt_uint length,
  webvtt_bool finish )
{
...
webvtt_lex( webvtt_parser self, const webvtt_byte *buffer, webvtt_uint *pos,
